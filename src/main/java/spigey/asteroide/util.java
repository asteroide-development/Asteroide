...
public class util {
    ...
    private static @NotNull StringBuilder getStringBuilder(List<String> commands) {
        ...
        final String nbt = "{display:{Lore:['[\"\",{\"text\":\"cmd1\",\"italic\":false,\"color\":\"gray\"},{\"text\":\", \",\"italic\":false,\"color\":\"dark_gray\"},{\"text\":\"cmd2\",\"italic\":false,\"color\":\"gray\"},{\"text\":\", \",\"italic\":false,\"color\":\"dark_gray\"},{\"text\":\"cmd3\",\"italic\":false,\"color\":\"gray\"},{\"text\":\"...\",\"italic\":false,\"color\":\"dark_gray\"}]','[\"\"]','[\"\",{\"text\":\"Generated by \",\"italic\":false,\"color\":\"dark_gray\"},{\"text\":\"username\",\"italic\":false,\"color\":\"gray\"},{\"text\":\" with \",\"italic\":false,\"color\":\"dark_gray\"},{\"text\":\"Asteroide\",\"italic\":false,\"bold\":true,\"color\":\"red\"},{\"text\":\".\",\"italic\":false,\"color\":\"dark_gray\"}]'],Name:'{\"text\":\"\",\"extra\":[{\"text\":\"Multi-Command Command Block\",\"italic\":true,\"color\":\"aqua\"}]}'},BlockEntityTag:{Command:'" + out.toString().replaceAll("'", "a");
        out.append("}]'}").append(nbt);
