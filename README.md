...
<a href="https://discord.gg/QFHCFynpkY">
  ...
  <a href="https://status.asteroide.cc/">
...
<a href="https://github.com/asteroide-development/Asteroide/releases">
    <img src="/.github/assets/download.png" height="110">
</a>
</div>
</div>
...
<table>
  ...
  <tr><td>Anti-Aim</td><td>Attempts to avoid players looking at you</td></tr>
  <tr><td>Anti-Announcement</td><td>Prevents the chat from being flooded from automated messages</td></tr>
  <tr><td>Anti-Anti-Xray</td><td>Attempts to bypass Anti Xray plugins by replacing fake layers of ores. Make sure to also enable Xray.</td></tr>
  <tr><td>Antisocial</td><td>Prevents you from going near specified entities.</td></tr>
  ...
  <tr><td>Auto-Command</td><td>Automatically runs a command when you are in a specific area.</td></tr>
  ...
  <tr><td>Auto-Macro</td><td>Automatically runs a command when a specified message is sent in the chat</td></tr>
  <tr><td>Auto-Shield</td><td>Automatically blocks when an arrow is about to hit you</td></tr>
  <tr><td>Better-Anti-Crash</td><td>Fixes various exploits and crashes.</td></tr>
  ...
  <tr><td>Cave-ESP</td><td>Displays large caves below you. Useful for digging down.</td></tr>
  <tr><td>Chat-Bypass</td><td>Bypasses most chat filters.</td></tr>
  <tr><td>Chest-Dumper</td><td>Dumps all items into inventories</td></tr>
  <tr><td>Chest-Stealer</td><td>Takes all items from Inventories</td></tr>
  <tr><td>Click-Events</td><td>ClickEvent Utils.</td></tr>
  ...
  <tr><td>Death-Message</td><td>Sends a message when you die</td></tr>
  <tr><td>Distribute</td><td>Automatically distributes duped items.</td></tr>
  ...
  <tr><td>Murder-Mystery-ESP</td><td>ESP for Hypixel Murder Mystery.</td></tr>
  <tr><td>No-Occlusion</td><td>Removes ambient occlusion.</td></tr>
  <tr><td>No-Recoil</td><td>Attempts to get rid of recoil on guns.</td></tr>
  <tr><td>Packet-Kick</td><td>Kicks you for sending too many packets.</td></tr>
  <tr><td>Packet-Logger</td><td>Logs sent/received packets</td></tr>
  <tr><td>Packet-Pause</td><td>Pauses packets until the module is disabled.</td></tr>
  <tr><td>Parkour-Bot</td><td>Automatically does parkour for you by teleporting.</td></tr>
  <tr><td>Passthrough</td><td>Allows you to interact through certain blocks.</td></tr>
  <tr><td>RTC-Settings</td><td>Settings for the .rtc command. Enable to apply settings.</td></tr>
  <tr><td>Safe-Elytra</td><td>Attempts to prevent dying from kinetic energy.</td></tr>
  <tr><td>Server-Crash</td><td>[REQUIRES OP] Crashes the server. Bee NoRender and EntityCulling mod highly recommended!</td></tr>
  <tr><td>Silent-Swap</td><td>Silently swaps to an item and back.</td></tr>
  <tr><td>Tracker</td><td>Tracks a player by always looking at it. Use with .track &lt;player&gt;</td></tr>
  <tr><td>Troll</td><td>Automatically msgs random people.</td></tr>
  <tr><td>Typo</td><td>Replaces text in sent messages/commands.</td></tr>
  <tr><td>Version-Spoof</td><td>UNMAINTAINED | Spoofs your minecraft version.</td></tr>
  <tr><td>Vulcan-Disabler</td><td>Movement Bypass for Vulcan AC 2.9.7.5 and under. Requires wearing an elytra.</td></tr>
...
<table>
  ...
  <tr><td>.bypass</td><td>Lets you bypass most chat filters</td></tr>
  <tr><td>.c</td><td>Solves math equations for you</td></tr>
  <tr><td>.cevr1</td><td>Crashes everyone else</td></tr>
  <tr><td>.channel</td><td>Channel chat messages into commands.</td></tr>
  <tr><td>.close</td><td>Closes the currently open GUI.</td></tr>
  <tr><td>.cmdblock</td><td>Gives you a command block with the specified command inside</td></tr>
  <tr><td>.copyitem</td><td>Copy someone's items.</td></tr>
  <tr><td>.delay</td><td>Sends the provided message after a specific delay.</td></tr>
  <tr><td>.dupe</td><td>Dupes the item in your hand & drops the results.</td></tr>
  <tr><td>.math</td><td>Solves math equations for you", "meth</td></tr>
  <tr><td>.me</td><td>Basic information for devs</td></tr>
  <tr><td>.perm</td><td>Tells you your permission level on the current server</td></tr>
  <tr><td>.phase</td><td>Vclip, but sideways</td></tr>
  <tr><td>.rtc</td><td>Asteroide RTC</td></tr>
  <tr><td>.scrash</td><td>Crashes the server</td></tr>
  <tr><td>.slot</td><td>Switches your equipped slot. Range 1 - 9</td></tr>
...
<table>
  <tr><th>Name</th><th>Description</th></tr>
  <tr><td>Image</td><td>Displays an image from the provided URL</td></tr>
  <tr><td>Minehut IP</td><td>The IP of the minehut server you're currently playing on</td></tr>
  <tr><td>Spoofed IP</td><td>Shows your IP that's spoofed from BungeeSpoof</td></tr>
  <tr><td>Username</td><td>Shows your username, good for cracked servers</td></tr>
</table></details>
